...
>(({ className, children, ...props }, ref) => {
  logger.info(
    "[Observabilidad] Renderizando NavigationMenu (Client Component)"
  );
  return (
...
>(({ className, ...props }, ref) => {
  logger.info("[Observabilidad] Renderizando NavigationMenuList");
  return (
...
>(({ className, children, ...props }, ref) => {
  logger.info("[Observabilidad] Renderizando NavigationMenuTrigger");
  return (
    ...
    >
      {children}{" "}
      <DynamicIcon // <-- ¡CORRECCIÓN APLICADA AQUÍ!
        name="ChevronDown"
...
>(({ className, ...props }, ref) => {
  logger.info("[Observabilidad] Renderizando NavigationMenuContent");
  return (
...
>(({ className, ...props }, ref) => {
  logger.info("[Observabilidad] Renderizando NavigationMenuViewport");
  return (
...
>(({ className, ...props }, ref) => {
  logger.info("[Observabilidad] Renderizando NavigationMenuIndicator");
  return (
