// RUTA: src/components/razBits/LightRays/light-rays.schema.ts
/**
 * @file light-rays.schema.ts
 * @description SSoT para el contrato de datos del componente LightRays.
 * @version 1.1.0 (Resilient Contract): Refactorizado para que todas las
